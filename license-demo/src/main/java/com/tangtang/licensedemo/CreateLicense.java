...
public class CreateLicense {
    ...
    private static String KEYPWD = "PASSWORD123";

    private static String STOREPWD = "tang1220";
    ...
    //license content
    private static String issuedTime = "2021-11-04";

    private static String notBefore = "2021-11-01";

    private static String notAfter = "2021-11-05";

    private static String consumerType = "user";
